...
GO
PRINT N'Dropping [SCCatalog].[FK_Ticket_User]...';


GO
ALTER TABLE [SCCatalog].[Ticket] DROP CONSTRAINT [FK_Ticket_User];


GO
PRINT N'Dropping [SCCatalog].[FK_TicketCommentMapping_User]...';


GO
ALTER TABLE [SCCatalog].[TicketCommentMapping] DROP CONSTRAINT [FK_TicketCommentMapping_User];
