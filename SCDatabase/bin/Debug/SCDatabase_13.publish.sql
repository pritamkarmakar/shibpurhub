...
GO
PRINT N'Altering [SCCatalog].[SecreteQuestionMaster]...';


GO
ALTER TABLE [SCCatalog].[SecreteQuestionMaster] ALTER COLUMN [QuestionHint] NCHAR (100) NULL;


GO
PRINT N'Creating [SCCatalog].[FK_UserSecreteMap_SCUser]...';


GO
ALTER TABLE [SCCatalog].[UserSecreteMap] WITH NOCHECK
    ADD CONSTRAINT [FK_UserSecreteMap_SCUser] FOREIGN KEY ([UserId]) REFERENCES [SCCatalog].[SCUser] ([UserId]);


GO
PRINT N'Creating [SCCatalog].[FK_UserSecreteMap_SecreteQuestionMaster]...';


GO
ALTER TABLE [SCCatalog].[UserSecreteMap] WITH NOCHECK
    ADD CONSTRAINT [FK_UserSecreteMap_SecreteQuestionMaster] FOREIGN KEY ([SecreteQuestionId]) REFERENCES [SCCatalog].[SecreteQuestionMaster] ([QuestionId]);
...
USING @LoadValues lv
ON (SM.QuestionId = lv.QuestionId)
WHEN MATCHED THEN
	UPDATE SET
...
SET IDENTITY_INSERT MSLCatalog.Country OFF
...
GO
ALTER TABLE [SCCatalog].[UserSecreteMap] WITH CHECK CHECK CONSTRAINT [FK_UserSecreteMap_SCUser];

ALTER TABLE [SCCatalog].[UserSecreteMap] WITH CHECK CHECK CONSTRAINT [FK_UserSecreteMap_SecreteQuestionMaster];
